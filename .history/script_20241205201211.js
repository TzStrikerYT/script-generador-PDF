function generateCertificates() {
  ...
  function drawFormattedText(doc, textParts, x, y, options = {}) {
    ...
    let currentLine = []; // Acumulador de palabras para la línea actual
  
    const drawLine = (line, justify = false) => {
      let currentX = x;
  
      if (justify && align === "justify") {
        // Ajustar el espaciado para justificar
      ...
      currentY += lineHeight;
      currentLine.length = 0; // Reiniciar la línea
    };
